...
/**
 * Class CamelcaseUnderdashMapper - mapper for conventions:
 ...
 */
class CamelcaseUnderdashMapper implements IMapper{
  ...
  public function getTable(string $entityClass):string {
    return self::camelToUnderdash(self::trimNamespace($entityClass));
  }
